...
begin
  ...
  values
    ...
    (v_resolved_business_id, 'products_enabled', true, 'profesional', true),
    (v_resolved_business_id, 'portfolio_enabled', true, 'profesional', true),
    (v_resolved_business_id, 'promotions_enabled', true, 'profesional', true),
